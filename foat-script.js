...
const FOAT_SIZES = [
  { label: '50×90 سم', desc: 'فوطة يد / وش' },
  { label: '70×140 سم', desc: 'فوطة جسم' },
  { label: '80×160 سم', desc: 'فوطة كبيرة' },
  { label: '90×180 سم', desc: 'فوطة لوكس' },
  { label: '100×200 سم', desc: 'فوطة فندقي' }
];
const BASHAER_SIZES = [
  { label: '70×140 سم', desc: 'بشكير صغير' },
  { label: '80×160 سم', desc: 'بشكير متوسط' },
  { label: '90×180 سم', desc: 'بشكير كبير' },
  { label: '100×200 سم', desc: 'بشكير كبير جداً' },
  { label: '60×120 سم', desc: 'بشكير أطفال' }
];
